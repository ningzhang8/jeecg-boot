package org.jeecg.modules.agent.orderform.vo;
 ...
 */
@Data
@ApiModel(value="sal_odrmPage对象", description="订单表")
public class SalOdrmPage {
	...
	@ExcelCollection(name="sal_odrd")
	@ApiModelProperty(value = "sal_odrd")
	private List<SalOdrd> salOdrdList;
